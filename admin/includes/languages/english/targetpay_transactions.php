...
define('TARGETPAY_TEXT_EXPLANATION', 'Bovenstaande tabel geeft een overzicht van de Digiwallet iDeal transacties 
                ...
                vertoond; dit ziet u aan het bolletje voor ' . TARGETPAY_TEXT_FILTER_INCOMPLETE . ' naast het knopje ' . TARGETPAY_TEXT_FILTER . '. 
                U kunt daar ook kiezen om ' . TARGETPAY_TEXT_FILTER_COMPLETE . ' of ' . TARGETPAY_TEXT_FILTER_ALL . ' transacties te laten vertonen. 
                ' . TARGETPAY_TEXT_FILTER_COMPLETE . ' transacties zijn transacties die afgerond zijn. ' . TARGETPAY_TEXT_FILTER_INCOMPLETE . ' 
